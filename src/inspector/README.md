...
frame adapter. `scripts/copy-assets.mjs` emits `dist/browser/inspector.js` and
...
The build uses esbuild, then `scripts/inspector-pool.mjs` shares repeated strings
...
[client adapters](../client/README.md), and [publication boundary](../browse/README.md).
