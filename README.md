...
The served shell exposes the same comparison in its Review mode: `/review`
generates the artifact on first visit, serves its index and compare pages
directly, and offers a recompute link that refreshes the comparison against
