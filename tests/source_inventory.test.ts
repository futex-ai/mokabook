...
test("failed page builds and source collisions preserve the previous inventory and bytes", async (context) => {
  ...
  await fs.promises.writeFile(
    fixture.entryPath,
    'import { definePage } from "mokly"; import html from "../mockups/document.html"; export const mockups = [definePage({ id: "page", title: "Page", description: "Page", dependencies: [], relatedDocs: [], route: "document.html", render: () => html })];',
  );
