# Registered Components In Mokabook's Design Catalogue
...
Give Mokabook's shared design UI its own real component pages, saved variants,
...
module-global collector or inspection of private Mokabook markers. Reject an
