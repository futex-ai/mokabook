...
contract until their standalone screens are implemented. The public website
screens under `design/site/` are not shell artboards; the
[site design](./site-design.md#mockups) document owns their inventory.
